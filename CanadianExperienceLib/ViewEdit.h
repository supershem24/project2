...
private:
    ...
    void OnMachine1Number(wxCommandEvent& event);
    void OnMachine2Number(wxCommandEvent& event);
    void OnMachine1Start(wxCommandEvent& event);
    void OnMachine2Start(wxCommandEvent& event);
